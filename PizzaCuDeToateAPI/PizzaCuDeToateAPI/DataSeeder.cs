...
public static class DataSeeder
{
    ...
    private static void AddItems(ApplicationContext context)
    {
        ...
        List<FoodItem> mozzarellaContainingFoodItems = 
            new() { foodItemPizzaCalifornia, foodItemPizzaVeggieMozzarella,foodItemPizzaSuprema,foodItemPizzaPepperoni,
        ...
        List<FoodItem> chickenContainingFoodItems = 
            new() {foodItemShawarmaComfortShaorma,foodItemPizzaChickenCorn,foodItemPizzaCalifornia,foodItemPizzaMeatLovers};
        List<FoodItem> beefContainingFoodItems = 
            new() {foodItemShawarmaShaormaSaracului,foodItemShawarmaShaormaCuCeva,foodItemPizzaSuprema,foodItemPizzaMeatLovers};
        List<FoodItem> pepperoniContainingFoodItems = 
            new() {foodItemPizzaPepperoniFeta,foodItemPizzaPepperoni,foodItemPizzaSuprema,foodItemPizzaMeatLovers,
        ...
        List<FoodItem> pepperContainingFoodItems = 
            new() {foodItemPizzaCalifornia,foodItemPizzaVeggieMozzarella,foodItemPizzaSuprema,foodItemPizzaAmericanSpicy,
        ...
        List<FoodItem> tomatoesContainingFoodItems = 
            new() {foodItemShawarmaShaormaCuCeva,foodItemShawarmaShaormaSaracului,foodItemPizzaVeggieMozzarella,
